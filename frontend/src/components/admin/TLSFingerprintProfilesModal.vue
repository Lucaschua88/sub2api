        ...
        <div>
          ...
          <div class="mt-1 flex items-center gap-2">
            ...
            <p class="text-xs text-gray-500 dark:text-gray-400">
              ...
              <a href="https://tls.secretapi.org" target="_blank" rel="noopener noreferrer" class="text-primary-600 hover:text-primary-700 dark:text-primary-400 dark:hover:text-primary-300 underline">{{ t('admin.tlsFingerprintProfiles.form.openCollector') }}</a>
            </p>
          </div>
        </div>
