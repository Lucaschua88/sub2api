              ...
              <template v-if="form.payment_enabled">
                ...
                <div class="grid grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    >
                      {{
                        (form.payment_product_name_prefix || "SecretAPI") +
                        " 100 " +
                ...
                <!-- Row 4: Enabled payment types (provider badges like secretapipay) -->
                <div>
                  <label class="input-label">{{
...
const paymentGuideHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Wei-Shaw/secretapi/blob/main/docs/PAYMENT_CN.md"
    : "https://github.com/Wei-Shaw/secretapi/blob/main/docs/PAYMENT.md",
);

const paymentMethodsHref = computed(() =>
  locale.value.startsWith("zh")
    ? "https://github.com/Wei-Shaw/secretapi/blob/main/docs/PAYMENT_CN.md#支持的支付方式"
    : "https://github.com/Wei-Shaw/secretapi/blob/main/docs/PAYMENT.md#supported-payment-methods",
);
